#!/usr/bin/env python3
"""
Recuperation des codes promo Vistaprint depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/vistaprint.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/vistaprint.fr"
STORE_NAME = "Vistaprint"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Vistaprint depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-vistaprint)"
    }
    try:
