 ...
 * Homepage: https://shopilo.fr/reductions/vistaprint.fr
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/vistaprint.fr";
const STORE_NAME  = "Vistaprint";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-vistaprint)" }
  });
